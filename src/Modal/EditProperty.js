...
class EditProperty extends Component {
  constructor(props) {
    ...
    const prop = this.props.properties.find(
      prop => prop.name === this.props.entity
    );
...
function mapDispatchToProps(dispatch) {
  return {
    editProperty: (tangoDB, device, name, value) =>
      dispatch(setDeviceProperty(tangoDB, device, name, value))
  };
}
